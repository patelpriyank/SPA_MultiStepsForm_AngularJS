...
var paths = {
    ...
    allScripts: 'app/**/*.js',
    allViews: 'app/**/*.html',
    commonStyles: 'app/common/styles/*.css',
    allImages: 'app/common/images/*',
    index: './app/index.html',
    partials: ['app/**/*.html', '!app/index.html'],
    distDev: './dist.dev',
    distScripts: './dist.dev/scripts',
    distCommonStyles: './dist.dev/common/styles',
    distImages: "./dist.dev/common/images/",
...
gulp.task('styles', function() {
  ...
  .pipe(gulp.dest(paths.distCommonStyles))
...
gulp.task('watch', ['lint'], function() {
  // Watch our scripts
  gulp.watch(['app/index.html', 'app/**/*.html', 'app/**/*.js', 'app/**/*.js', 'app/**/*.css'],[
    'lint',
    'browserify',
    'views',
    'styles'
